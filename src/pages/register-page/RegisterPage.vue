...
<template>
  <AppHeader />
  <main class="flex-1 flex flex-col justify-center pt-20 pb-10">
    <div class="mx-auto max-w-sm w-full">
      <h1 class="mb-8 text-3xl font-semibold px-6">Регистрация</h1>
      <VSheet class="p-6">
        <FormRegister />
        <VLink :to="RoutesPath.login" class="block mt-6">
